...
const AnimatedCounter = ({ end, suffix = "", text }: { end: number; suffix?: string; text: string }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6">
      <div className="text-4xl font-serif font-bold mb-2" style={{ color: "#F4D03F" }}>
        {count}{suffix}
      </div>
    ...
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      <div className="bg-primary text-white text-xs py-2 px-4 flex flex-col sm:flex-row justify-between items-center z-50 relative">
        ...
        <div className="flex items-center gap-3">
          <a href="#" className="hover:text-yellow-300 transition-colors"><Facebook size={14} /></a>
          <a href="#" className="hover:text-yellow-300 transition-colors"><Twitter size={14} /></a>
          <a href="#" className="hover:text-yellow-300 transition-colors"><Instagram size={14} /></a>
          <a href="#" className="hover:text-yellow-300 transition-colors"><Youtube size={14} /></a>
        </div>
      </div>

      {/* 2. HEADER */}
      <div className="relative overflow-hidden" style={{ backgroundColor: "#F7F9F9" }}>
        <div
          className="absolute inset-0 opacity-5"
          style={{ backgroundImage: "radial-gradient(#2C3E50 1px, transparent 1px)", backgroundSize: "20px 20px" }}
        />
        <div className="container mx-auto px-4 py-8 flex flex-col md:flex-row items-center justify-center md:justify-start gap-6 relative z-10">
          <div className="w-24 h-24 rounded-full flex items-center justify-center border-4 border-white shadow-lg shrink-0" style={{ backgroundColor: "#F4D03F" }}>
        ...
        <div className="w-full h-1 opacity-50" style={{ background: "linear-gradient(to right, transparent, #F4D03F, transparent)" }} />
      </div>
      ...
      <div
        ...
        style={!isScrolled ? { backgroundColor: "#F7F9F9", borderColor: "#E5E7EB" } : {}}
      >
            ...
            {navLinks.map((link) => (
              <button
                ...
                className={cn(
                  ...
                  isScrolled ? "text-white hover:text-yellow-300" : "text-primary hover:text-yellow-500"
                )}
              >
                {link.name}
              </button>
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-primary">
        <div
          ...
          style={{ backgroundImage: "radial-gradient(circle at center, #F4D03F 2px, transparent 2px)", backgroundSize: "40px 40px" }}
        />
        ...
        >
          ...
          >
            <span className="font-serif text-xl md:text-2xl" style={{ color: "#F4D03F" }}>&ldquo;&#2357;&#2367;&#2342;&#2381;&#2351;&#2366; &#2342;&#2342;&#2366;&#2340;&#2367; &#2357;&#2367;&#2344;&#2351;&#2350;&#2381;&rdquo;</span>
          ...
          >
            Shaping Tomorrow&apos;s{" "}
            <span style={{ color: "#F4D03F" }}>Leaders</span>
          </motion.h1>
          ...
          >
            <Button
              ...
              className="border-none text-lg px-8 py-6 rounded-sm shadow-lg font-bold"
              style={{ backgroundColor: "#F4D03F", color: "#2C3E50" }}
            >
              Apply Now
            </Button>
            <Button
              ...
              style={{ borderColor: "#F4D03F", color: "#F4D03F" }}
            >
              Learn More
            </Button>
          </motion.div>
      ...
      {/* 6. ABOUT SECTION */}
      <section id="about" className="py-24 relative" style={{ backgroundColor: "#F7F9F9" }}>
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto p-8 md:p-12 relative bg-white shadow-xl" style={{ border: "8px double rgba(44,62,80,0.1)" }}>
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 px-4" style={{ backgroundColor: "#F7F9F9" }}>
              <span className="text-4xl" style={{ color: "#F4D03F" }}>&#10087;</span>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-4xl font-serif font-bold text-primary mb-6 relative inline-block">
                  Our Legacy
                  <div className="absolute -bottom-2 left-0 w-1/2 h-1" style={{ backgroundColor: "#F4D03F" }} />
                </h2>
                ...
                <div className="space-y-4 mb-8">
                  ...
                  <div className="p-4 border-l-4" style={{ backgroundColor: "rgba(244,208,63,0.15)", borderColor: "#F4D03F" }}>
                    <h3 className="font-serif font-bold text-xl mb-1 text-primary">Our Vision</h3>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  { title: "CBSE Affiliated", icon: <CheckCircle2 size={32} className="mb-2 text-primary" /> },
                  { title: "Hindi & English", icon: <BookOpen size={32} className="mb-2 text-primary" /> },
                  { title: "Girls Only", icon: <Trophy size={32} className="mb-2 text-primary" /> },
                  { title: "50+ Years", icon: <Sparkles size={32} className="mb-2 text-primary" /> },
                ].map((badge, idx) => (
                  <div
                    key={idx}
                    ...
                    style={{ backgroundColor: "#F7F9F9", borderColor: "#E5E7EB" }}
                  >
      ...
      <section id="academics" className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <div className="w-24 h-1 mx-auto mb-6" style={{ backgroundColor: "#F4D03F" }} />
            ...
            {[
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <div className="inline-block font-bold px-3 py-1 rounded text-sm mb-4 self-start text-primary" style={{ backgroundColor: "rgba(244,208,63,0.2)" }}>
                    {prog.classes}
                  </div>
      ...
      {/* 8. FACILITIES GRID */}
      <section id="facilities" className="py-24" style={{ backgroundColor: "#F7F9F9" }}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            {[
              ...
              >
                <div
                  ...
                  style={{ backgroundColor: "rgba(244,208,63,0.25)", color: "#2C3E50" }}
                  onMouseEnter={(e) => { (e.currentTarget as HTMLDivElement).style.backgroundColor = "#F4D03F"; }}
                  onMouseLeave={(e) => { (e.currentTarget as HTMLDivElement).style.backgroundColor = "rgba(244,208,63,0.25)"; }}
                >
                  {fac.icon}
                </div>
      ...
      {/* 9. NOTICE BOARD */}
      <section id="notice-board" className="py-24 relative" style={{ backgroundColor: "#ECEFF1" }}>
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto p-4 md:p-8 rounded-sm shadow-2xl" style={{ backgroundColor: "#2C3E50", border: "12px solid #1F2A38" }}>
            <div className="text-center mb-8 py-4 rounded shadow-inner border-2 mx-auto max-w-sm" style={{ backgroundColor: "#F7F9F9", borderColor: "#E5E7EB" }}>
              ...
              {[
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 items-start sm:items-center pt-2">
                    <span className="text-xs font-bold px-2 py-1 rounded shrink-0" style={{ backgroundColor: "#F4D03F", color: "#2C3E50" }}>{notice.date}</span>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div
              ...
              style={{ border: "8px solid #F4D03F", backgroundColor: "#34495E" }}
            >
              <div className="absolute inset-0 z-10" style={{ background: "linear-gradient(to top right, rgba(0,0,0,0.4), transparent)" }} />
              <svg viewBox="0 0 24 24" className="w-32 h-32 opacity-40" fill="#F4D03F">
                <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" />
              </svg>
            </div>

            <div>
              <h2 className="text-4xl font-serif font-bold mb-6" style={{ color: "#F4D03F" }}>Message from the Principal</h2>
              ...
              <div>
                ...
                <p className="font-semibold uppercase tracking-wider text-sm mt-1" style={{ color: "#F4D03F" }}>Principal, HGSS</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <div className="w-24 h-1 mx-auto" style={{ backgroundColor: "#F4D03F" }} />
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-6xl mx-auto">
            {[
              ...
              <div key={idx} className="group relative overflow-hidden rounded-sm bg-muted" style={{ aspectRatio: "4/3" }}>
                ...
                />
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end" style={{ background: "linear-gradient(to top, rgba(44,62,80,0.9) 0%, rgba(44,62,80,0.2) 60%, transparent 100%)" }}>
      ...
      <section id="admissions" className="py-24 border-y" style={{ backgroundColor: "#F7F9F9", borderColor: "#E5E7EB" }}>
        <div className="container mx-auto px-4 text-center">
          ...
          <Button
            size="lg"
            className="text-lg px-10 py-6 rounded-sm font-bold"
            style={{ backgroundColor: "#F4D03F", color: "#2C3E50" }}
      ...
      <section id="contact" className="py-24 bg-white relative overflow-hidden">
        <div
          ...
          style={{ backgroundImage: "radial-gradient(#F4D03F 1px, transparent 1px)", backgroundSize: "30px 30px" }}
        />
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto shadow-xl border overflow-hidden rounded-sm" style={{ backgroundColor: "#F7F9F9", borderColor: "#E5E7EB" }}>
            <div className="grid md:grid-cols-2">
              ...
              <div className="bg-primary p-8 md:p-12 relative overflow-hidden">
                <div
                  ...
                  style={{ backgroundColor: "rgba(244,208,63,0.2)" }}
                />
                <h2 className="text-3xl font-serif font-bold mb-8" style={{ color: "#F4D03F" }}>Contact Info</h2>

                <div className="space-y-6 relative z-10">
                  {[
                    {
                      icon: <MapPin style={{ color: "#F4D03F" }} className="shrink-0 mt-1" />,
                      label: "Address",
                      content: "[School Address Line 1]\n[City, State, Pincode]",
                    },
                    {
                      icon: <Phone style={{ color: "#F4D03F" }} className="shrink-0 mt-1" />,
                      label: "Phone",
                      content: "+91-XXXXXXXXXX\n+91-XXXXXXXXXX",
                    },
                    {
                      icon: <Mail style={{ color: "#F4D03F" }} className="shrink-0 mt-1" />,
                      label: "Email",
      ...
      {/* 14. FOOTER */}
      <footer style={{ backgroundColor: "#1F2A38", color: "#F7F9F9" }} className="pt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 rounded-full flex items-center justify-center border-2 border-white shrink-0" style={{ backgroundColor: "#F4D03F" }}>
                  <span>🏫</span>
                </div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-white/70">
                <li className="flex items-start gap-3">
                  <MapPin size={16} className="mt-1 shrink-0" style={{ color: "#F4D03F" }} />
                  <span>[School Address], [City]</span>
                </li>
                <li className="flex items-center gap-3">
                  <Phone size={16} className="shrink-0" style={{ color: "#F4D03F" }} />
                  <span>+91-XXXXXXXXXX</span>
                </li>
                <li className="flex items-center gap-3">
                  <Mail size={16} className="shrink-0" style={{ color: "#F4D03F" }} />
                  <span>info@hgsschool.edu.in</span>
                </li>
              </ul>
            </div>
        ...
        {/* Bottom Bar */}
        <div className="py-4 text-center text-xs" style={{ backgroundColor: "#131C26", color: "rgba(255,255,255,0.5)" }}>
          <div className="container mx-auto px-4">
